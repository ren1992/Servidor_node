...
function initModels(sequelize) {
  ...
  orden.belongsTo(empresa, { as: "empresa_idempresa_empresa", foreignKey: "empresa_idempresa"});
  empresa.hasMany(orden, { as: "ordens", foreignKey: "empresa_idempresa"});
  ...
  orden.belongsTo(forma_pago, { as: "forma_pago_idforma_pago_forma_pago", foreignKey: "forma_pago_idforma_pago"});
  forma_pago.hasMany(orden, { as: "ordens", foreignKey: "forma_pago_idforma_pago"});
  ...
  plato.belongsTo(orden, { as: "orden_idorden_orden", foreignKey: "orden_idorden"});
  orden.hasMany(plato, { as: "platos", foreignKey: "orden_idorden"});
  producto.belongsTo(orden, { as: "orden_idorden1_orden", foreignKey: "orden_idorden1"});
  orden.hasMany(producto, { as: "productos", foreignKey: "orden_idorden1"});
  ...
  compra.belongsTo(producto, { as: "productos_idproductos_producto", foreignKey: "productos_idproductos"});
  producto.hasMany(compra, { as: "compras", foreignKey: "productos_idproductos"});
  ...
  orden.belongsTo(tarifa, { as: "tarifa_idtarifa_tarifa", foreignKey: "tarifa_idtarifa"});
  tarifa.hasMany(orden, { as: "ordens", foreignKey: "tarifa_idtarifa"});
  ...
  gerente.belongsTo(usuario, { as: "usuario_idusuario_usuario", foreignKey: "usuario_idusuario"});
